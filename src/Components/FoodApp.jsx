...
export default function FoodApp(){
    return(
        ...
        <div className={styles.container}>
            ...
            <a className={styles.spoo} href="https://spoonacular.com/food-api"> spoonacular.com</a>, ordenarlas, filtrarlas y buscarlas por nombre o por el paginado. Además de poder crear tus propias recetas.</p>
            </div>
            </div>
...
<div class="carousel-item active">
  ...
  <img  className={styles.img}  src={foodApp3} alt="First slide"/>
  </div>
</div>
<div class="carousel-item">
<div className={styles.imgcontainer}>
  <img className={styles.img} src={foodApp} alt="Second slide"/>
</div>
</div>
 <div class="carousel-item">
 <div className={styles.imgcontainer}>
  <img className={styles.img} src={foodApp2} alt="Third slide"/>
  </div>
</div>
<div class="carousel-item">
 <div className={styles.imgcontainer}>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div className={styles.github}>
            <a className={styles.codigo} href="https://github.com/LucasRomanGervasi/Today-s-Menu"> <span className={styles.iconogit}><BsGithub/></span>Codigo de Today's Menu</a>
        </div>
        </div>
        </div>
    )
