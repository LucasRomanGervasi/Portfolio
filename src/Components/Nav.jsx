    ...
    <div className={nav ? styles.botones : styles.botonesarriba}>
      <div className={styles.botonera}>
        <div className={styles.imagenContainer}>
          <img className={styles.foto} src={logo}></img>
        </div>
        <a className={styles.boton} href="#aboutMe">
          SOBRE MI
        </a>
      ...
      <div className={nav ? styles.botonera2 : styles.botonera3}>
        <div className={styles.imagenContainer2}>
          <img className={styles.foto2} src={logo}></img>
        </div>
        <div className="switch-checkbox">
          <label className="switch">
            <input type="checkbox" onClick={handleClick} />
      ...
      {showMobileBurger ? (
        <div className={styles.botones2}>
          <div
            className={
              darkMode ? styles.containerBurger2 : styles.containerBurger
            }
          >
            <a
