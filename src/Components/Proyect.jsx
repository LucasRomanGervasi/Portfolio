...
export default function Proyect() {
  ...
  return (
    <div
      id="proyect"
      className={darkMode ? styles.proyectos : styles.proyectos2}
    >
        ...
        <div className={styles.container1}>
          <div className={styles.containerFood}>
            <div className={styles.foodAppFront}>
              ...
              <img className={styles.foodImg} src={foodApp}></img>
              <a className={styles.boton} href="/TodaysMenu">
                Ver más
              </a>
            </div>
          </div>
          <div className={styles.containerFood}>
            <div className={styles.foodAppFront}>
              ...
              <img className={styles.foodImg} src={restoBook}></img>
              <a className={styles.boton} href="/RestoBook">
                Ver más
              </a>
            </div>
          </div>
          <div className={styles.containerfin}>
            <div className={darkMode ? styles.fin2 : styles.fin}></div>
          </div>
        </div>
      </div>
    </div>
