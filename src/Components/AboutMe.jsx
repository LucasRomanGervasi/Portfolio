          ...
          <div className={darkMode ? styles.wrapper : styles.wrapper2}>
            <div className={styles.dataaos} data-aos="fade-right">
              ...
              <div className={styles.parrafo}>
                ...
                <p className={styles.parrafo2}>
                  En 2020, época de pandemía, decidí dar un giro en mi vida y
                  entrar en el mundo IT. Hoy en día soy un{" "}
                  <a
                    style={
                      darkMode ? { color: "#411af3" } : { color: "rgb(0,0,60)" }
                    }
                  >
                    {" "}
                    DESARROLLADOR WEB FULL STACK{" "}
                  </a>
                  . Tengo experiencia creando apps desde{" "}
                  <a
                    style={
                      darkMode ? { color: "#411af3" } : { color: "rgb(0,0,60)" }
                    }
            ...
            <div className={styles.curvas}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path
                  fill="#000000"
                  fill-opacity="1"
                  d="M0,224L60,202.7C120,181,240,139,360,138.7C480,139,600,181,720,208C840,235,960,245,1080,240C1200,235,1320,213,1380,202.7L1440,192L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"
                ></path>
              </svg>
            </div>
          ) : (
